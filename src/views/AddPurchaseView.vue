    ...
    <div class="max-w-3xl mx-auto w-full h-full flex flex-col">
      <div v-if="step === 1" class="flex flex-col flex-grow relative pb-1">
        ...
        <div class="flex flex-col items-center justify-center px-6">
          ...
          >
            Collez un lien ou une image pour évaluer si cet achat est
            nécessaire.
          </p>
        ...
        >
          ...
          <div>
            ...
            <p class="text-sm text-[#4B5563] leading-snug">
              Ces informations permettent à l'IA d'évaluer la véritable utilité
              de cet achat.
            </p>
          </div>
        </div>
          ...
          <div class="space-y-4">
            ...
            <div class="space-y-1">
              <CustomSelect
                ...
                placeholder="Sélectionnez un portefeuille"
                :error="
                  isWalletInsufficient ||
                  (!formData.wallet_type &&
                    walletOptions.every((o) => o.disabled))
                "
              />
              <p
                v-if="isWalletInsufficient"
                class="text-xs text-red-500 font-medium ml-2"
              >
                Le prix de l'article dépasse le solde disponible de ce
                portefeuille.
              </p>
              <p
                v-else-if="
                ...
                class="text-xs text-red-500 font-medium ml-2 animate-pulse"
              >
                Aucun portefeuille avec un solde suffisant n'est disponible.
              </p>
            </div>
          </div>
...
const isWalletInsufficient = computed(() => {
  ...
  const selectedOpt = walletOptions.value.find(
    (o) => o.value === formData.wallet_type,
  );
