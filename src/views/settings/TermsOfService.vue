<template>
  ...
  >
    <div class="w-full max-w-3xl px-4 sm:px-6 md:px-8 py-6 sm:py-8 lg:py-10">
      <SettingsPageHeader title="Conditions d'utilisation" />

      <section class="premium-card">
        <div
          class="space-y-6 sm:space-y-8 text-[14px] sm:text-[15px] leading-relaxed text-[#6B7280]"
        >
          <div>
            <h2
              class="text-lg sm:text-xl font-bold text-[#000000] mb-2 sm:mb-3"
            >
          ...
          <div>
            <h2
              class="text-lg sm:text-xl font-bold text-[#000000] mb-2 sm:mb-3"
            >
              2. Accès aux services et création de compte
            </h2>
            <p>
          ...
          <div>
            <h2
              class="text-lg sm:text-xl font-bold text-[#000000] mb-2 sm:mb-3"
            >
              4. Engagements et comportement de l'utilisateur
            </h2>
            <p class="mb-3">
              En utilisant nos services, vous vous engagez à ne pas :
            </p>
            <ul
              class="list-disc pl-5 sm:pl-6 space-y-2 mb-3 marker:text-[#9CA3AF]"
            >
              <li>
