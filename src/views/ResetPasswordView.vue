<template>
  <div
    class="min-h-screen bg-[#F8F6F2] flex flex-col items-center px-6 py-12 font-sans selection:bg-[#5A877E] selection:text-white"
  >
    <div
    ...
    >
      ...
      <span class="text-xs opacity-80 mt-2 block"
        >Redirection vers la connexion...</span
      >
    </div>
    ...
    >
      ...
      <button
        ...
        class="w-full mt-4 bg-[#5A877E] text-white rounded-2xl py-3.5 font-semibold text-sm hover:bg-[#4A726A] transition-colors active:scale-[0.98] shadow-md shadow-[#5A877E]/20 disabled:opacity-70 disabled:cursor-not-allowed"
      >
